 ...
 * @since 5.0.0
 */
public final class PlexusIoSarFileResourceCollectionProvider extends AbstractPlexusIoResourceCollectionProvider {
    ...
    protected PlexusIoResourceCollection createResourceCollection() {
        return new PlexusIoSarFileResourceCollection();
    }
}
