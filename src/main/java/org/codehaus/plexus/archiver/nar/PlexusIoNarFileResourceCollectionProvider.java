 ...
 * @since 5.0.0
 */
public final class PlexusIoNarFileResourceCollectionProvider extends AbstractPlexusIoResourceCollectionProvider {
    ...
    protected PlexusIoResourceCollection createResourceCollection() {
        return new PlexusIoNarFileResourceCollection();
    }
}
