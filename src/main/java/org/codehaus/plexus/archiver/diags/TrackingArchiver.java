...
public class TrackingArchiver implements Archiver {
    ...
    @Override
    public void addFile(final @Nonnull File inputFile, final @Nonnull String destFileName) throws ArchiverException {
    ...
    public @Nonnull @Override ResourceIterator getResources() throws ArchiverException {
