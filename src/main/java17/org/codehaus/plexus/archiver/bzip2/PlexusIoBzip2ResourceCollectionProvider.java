 ...
 * @since 5.0.0
 */
public final class PlexusIoBzip2ResourceCollectionProvider extends AbstractPlexusIoResourceCollectionProvider {
    ...
    protected PlexusIoResourceCollection createResourceCollection() {
        return new PlexusIoBzip2ResourceCollection();
    }
}
