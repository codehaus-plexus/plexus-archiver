 ...
 * @since 5.0.0
 */
public final class DefaultPlexusIoFileResourceCollectionProvider extends AbstractPlexusIoResourceCollectionProvider {
    ...
    protected PlexusIoResourceCollection createResourceCollection() {
        return new DefaultPlexusIoFileResourceCollection();
    }
}
