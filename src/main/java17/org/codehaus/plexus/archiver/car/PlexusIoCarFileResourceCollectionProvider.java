 ...
 * @since 5.0.0
 */
public final class PlexusIoCarFileResourceCollectionProvider extends AbstractPlexusIoResourceCollectionProvider {
    ...
    protected PlexusIoResourceCollection createResourceCollection() {
        return new PlexusIoCarFileResourceCollection();
    }
}
