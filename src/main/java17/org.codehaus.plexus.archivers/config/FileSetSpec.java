...
/**
 * Fluent specification of files rooted at a directory.
 *
 * @since 5.0.0
 */
public final class FileSetSpec {
    ...
    private FileSetSpec(Path directory) {
        this.directory = Objects.requireNonNull(directory, "directory");
    }

    public static FileSetSpec of(Path directory) {
        return new FileSetSpec(directory);
    }

    public FileSetSpec prefixed(String prefix) {
        this.prefix = prefix;
        return this;
    }

    public FileSetSpec including(Collection<String> includes) {
        this.includes = List.copyOf(includes);
        return this;
    }

    public FileSetSpec excluding(Collection<String> excludes) {
        this.excludes = List.copyOf(excludes);
        return this;
    }

    public FileSetSpec caseSensitive(CaseSensitivity caseSensitivity) {
        this.caseSensitivity = Objects.requireNonNull(caseSensitivity, "caseSensitivity");
        return this;
    }

    public FileSetSpec usingDefaultExcludes(DefaultExcludes defaultExcludes) {
        this.defaultExcludes = Objects.requireNonNull(defaultExcludes, "defaultExcludes");
        return this;
    }

    public FileSetSpec emptyDirectories(EmptyDirectoryHandling emptyDirectoryHandling) {
    ...
    public FileSetSpec selectedBy(Collection<FileSelector> fileSelectors) {
        this.fileSelectors = List.copyOf(fileSelectors);
        return this;
    }

    public FileSetSpec transformedBy(InputStreamTransformer streamTransformer) {
        this.streamTransformer = Objects.requireNonNull(streamTransformer, "streamTransformer");
        return this;
    }

    public FileSetSpec mappedBy(Collection<FileMapper> fileMappers) {
